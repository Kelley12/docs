...
![](../../.gitbook/assets/hosted-no-deployments.png)
...
![](../../.gitbook/assets/hosted-create-deployment.png)
...
![](../../.gitbook/assets/hosted-create-deployment-complete.png)

Click the "Create Deployment" button. Your deployment will go into "Starting" phase.

![](../../.gitbook/assets/hosted-deployment-starting.png)
...
![](../../.gitbook/assets/hosted-deployment-complete.png)
...
![](../../.gitbook/assets/hosted-workbench-landing.png)
...
![](../../.gitbook/assets/hosted-workbench-empty-db.png)
...
![](../../.gitbook/assets/create-table-queries.png)
...
![](../../.gitbook/assets/after-query-diff.png)

I finish up by subsequently running the last two create table queries.

![](../../.gitbook/assets/multi-table-diff.png)
...
![](../../.gitbook/assets/deployment-settings.png)
...
![](../../.gitbook/assets/connect-to-server.png)
...
![](../../.gitbook/assets/workbench-empty-tables.png)

But on the inserts branch there are!

![](../../.gitbook/assets/workbench-filled-tables.png)
...
![](../../.gitbook/assets/workbench-create-pull-request.png)
...
![](../../.gitbook/assets/workbench-changes-live.png)
