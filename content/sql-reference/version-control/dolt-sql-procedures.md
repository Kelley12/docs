...
* [Dolt SQL Procedures](dolt-sql-procedures.md#dolt-sql-procedures)
  ...
  * [dolt\_cherry\_pick()](dolt-sql-procedures.md#dolt\_cherry\_pick)
...
Works exactly like [`dolt cherry-pick` command](../../cli-reference/cli.md#dolt-cherry-pick) on the CLI, and has the same notes and limitations.
